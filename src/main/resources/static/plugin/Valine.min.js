...
!function (e, t) {
    ...
    return function (e) {
        ...
        var i, a, s = function () {
            ...
            }() : s, c = n(45)(), u = Object.getPrototypeOf || function (e) {
                return e.__proto__
            }, d = i ? u(i) : void 0, p = a ? u(a) : void 0, f = a ? a() : void 0,
            h = "undefined" == typeof Uint8Array ? void 0 : u(Uint8Array), g = {
                "%Array%": Array,
            ...
            }, v = n(3), m = v.call(Function.call, String.prototype.replace),
            y = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,
            b = /\\(\\)?/g, w = function (e) {
                var t = [];
        ...
        n(30);
        var i = n(36), a = r(i), s = n(27), l = r(s), c = n(26), u = r(c), d = n(40), p = r(d), f = n(25), h = r(f),
            g = document, v = (window, navigator), m = /[&<>"'`\\]/g, y = RegExp(m.source),
            b = /&(?:amp|lt|gt|quot|#39|#x60|#x5c);/g, w = RegExp(b.source),
            x = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "`": "&#x60;", "\\": "&#x5c;"},
            k = {};
        ...
        "use strict";
        var r = n(38), o = "function" == typeof Symbol && "symbol" == typeof Symbol("foo"),
        ...
        "use strict";
        var r = n(43), o = n(42), i = n(44), a = i("String.prototype.replace"),
        ...
        "use strict";
        var r = n(3), o = n(0), i = o("%Function%"), a = i.apply, s = i.call;
        e.exports = function () {
        ...
        var x = n(2).FilterCSS, k = n(2).getDefaultWhiteList, _ = n(4), A = new x, S = /</g, O = />/g, E = /"/g,
            $ = /&quot;/g, j = /&#([a-zA-Z0-9]*);?/gim, T = /&colon;?/gim, I = /&newline;?/gim,
            C = /((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a)\:/gi,
            P = /e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi, M = /u\s*r\s*l\s*\(.*/gi, z = /<!--[\s\S]*?-->/g;
        ...
        function a(e, t) {
            ...
            for (var r = 0, o = [], i = !1, a = e.length, c = 0; c < a; c++) {
                ...
                if (!1 !== i || "=" !== g) if (!1 === i || c !== r || '"' !== g && "'" !== g || "=" !== e.charAt(c - 1)) if (/\s|\n|\t/.test(g)) {
                    if (e = e.replace(/\s|\n|\t/g, " "), !1 === i) {
                        if (-1 === (h = s(e, c))) {
...
*/
        ...
        t.__esModule = !0;
        var o = n(35), i = r(o), a = n(53), s = r(a), l = n(54), c = r(l), u = n(51), d = r(u), p = n(52), f = r(p),
            h = {
                zh: s.default,
                "zh-cn": s.default,
                "zh-CN": s.default,
        ...
        var a = n(22), s = r(a), l = n(24), c = r(l), u = n(16), d = r(u), p = n(23), f = r(p), h = n(17), g = r(h),
            v = n(19), m = r(v), y = n(5), b = n(20), w = r(b), x = n(21), k = r(x), _ = n(1), A = r(_),
            S = {comment: "", nick: username, mail: "", link: "http://cn-zz-bgp.sakurafrp.com:10340/bookshop/view/userAllBookList.html#?userId="+id, ua: A.default.ua, url: ""}, O = "", E = {
        ...
        o.prototype.init = function (e) {
            ...
            try {
                var t = e.config, n = t.avatar, r = t.avatarForce, o = t.avatar_cdn, i = t.visitor, a = t.path,
                    s = void 0 === a ? location.pathname : a, l = t.pageSize, u = t.recordIP;
                e.config.path = s.replace(/index\.html?$/, "");
                var d = E.ds, p = r ? "&q=" + Math.random().toString(32).substring(2) : "";
                ...
                var h = e.config.app_id || e.config.appId, g = e.config.app_key || e.config.appKey;
                if (!h || !g) return;
                var v = "https://", m = "";
                ...
                var y = (0, A.default)(".valine-comment-count"), b = 0;
                !function t(n) {
                    var r = n[b++];
                    if (r) {
                ...
                var w = e.config.el || null, x = (0, A.default)(w);
                ...
                var k = (0 == e.config.meta.length ? $ : e.config.meta).map(function (t) {
                        ...
                        return $.indexOf(t) > -1 ? '<input name="' + t + '" placeholder="' + e.i18n.t(t) + '" class="v' + t + ' vinput" type="hidden">' : ""
                    }),
                ...
                var j = e.$el.find(".load-bottom"), I = e.$el.find(".load-top");
                e.loading = {
                    show: function (t) {
        ...
        var j = function (e, t) {
            ...
            add: function (e, t) {
                ...
                if (1 === r.length) {
                    var o = r[0], i = decodeURI((0, A.default)(o).attr("id")),
                        a = (0, A.default)(o).attr("data-flag-title"), s = encodeURI(i),
        ...
        o.prototype.Q = function (e) {
            ...
            var e = this, t = e.$el.find(".vemojis"), n = e.$el.find(".vpreview"), r = e.$el.find(".vemoji-btn"),
                o = e.$el.find(".vpreview-btn"), i = e.$el.find(".veditor"), a = m.default.data, l = !1,
                u = function (e) {
                    var n = [];
            ...
            var f = e.config.meta, h = {}, g = {veditor: "comment"};
            f.forEach(function (e) {
                g["v" + e] = e
            });
            for (var v in g) g.hasOwnProperty(v) && function () {
                var t = g[v], n = e.$el.find("." + v);
            ...
            var j = function (t, n, r) {
                var o = (0, A.default)('<div class="vcard" id="' + t.id + '"></div>'), i = t.get("ua"), a = "";
                i && !/ja/.test(e.config.lang) && (i = A.default.detect(i), a = '' + "</span>"), "*" === e.config.path && (a = '<a href="' + t.get("url") + '" class="vsys">' + t.get("url") + "</a>");
                var l = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : "",
                    c = l ? '<a class="vnick" rel="nofollow" href="' + l + '" target="_self" >' + t.get("nick") + "</a>" : '<span class="vnick">' + t.get("nick") + "</span>",
                ...
                t.on("click", function (r) {
                    var o = t.attr("data-root-id"), i = t.attr("data-self-id"), a = e.$el.find(".vwrap"),
            ...
            var M = e.$el.find(".vsubmit"), z = function (t) {
                ...
                S.comment = O, S.nick = S.nick || username;
                ...
                A.default.store.set("vlx", Date.now()), M.attr({disabled: !0}), e.loading.show(!0);
                ...
                n.setACL(L()), n.save().then(function (t) {
                    username != S.nick && A.default.store.set("ValineCache", {
                        nick: S.nick,
                        link: S.link,
                        mail: S.mail
                    });
        ...
        (function (t) {
            !function (t) {
                ...
                g._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/, g._title = /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/, g.def = c(g.def).replace("label", g._label).replace("title", g._title).getRegex(), g.bullet = /(?:[*+-]|\d+\.)/, g.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/, g.item = c(g.item, "gm").replace(/bull/g, g.bullet).getRegex(), g.list = c(g.list).replace(/bull/g, g.bullet).replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + g.def.source + ")").getRegex(), g._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", g._comment = /<!--(?!-?>)[\s\S]*?-->/, g.html = c(g.html, "i").replace("comment", g._comment).replace("tag", g._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), g.paragraph = c(g.paragraph).replace("hr", g.hr).replace("heading", g.heading).replace("lheading", g.lheading).replace("tag", g._tag).getRegex(), g.blockquote = c(g.blockquote).replace("paragraph", g.paragraph).getRegex(), g.normal = p({}, g), g.gfm = p({}, g.normal, {
                    ...
                    e = e.replace(/^ +$/gm, "");
                    for (var n, r, o, i, a, s, l, c, u, d, p, h, v; e;) if ((o = this.rules.newline.exec(e)) && (e = e.substring(o[0].length), o[0].length > 1 && this.tokens.push({type: "space"})), o = this.rules.code.exec(e)) e = e.substring(o[0].length), o = o[0].replace(/^ {4}/gm, ""), this.tokens.push({
                        type: "code",
        ...
        var r = n(1), o = function (e) {
            ...
            if (!t || t.v !== e) {
                ...
                var n = o.default.navi, r = "3a67769b7760c62aafb6fa58d51da74c", i = window, a = document,
        ...
        "use strict";
        var r = n(34), o = Object.prototype.toString, i = Object.prototype.hasOwnProperty, a = function (e, t, n) {
        ...
        var u = n(31), d = n(48), p = n(33), f = n(41), h = function (e) {
            d(!1, e)
        }, g = String.prototype.replace, v = String.prototype.split, m = "||||", y = function (e) {
            var t = e % 100, n = t % 10;
...
*/
        ...
        var r;
        if (!Object.keys) {
            var o = Object.prototype.hasOwnProperty, i = Object.prototype.toString, a = n(9),
        ...
        "use strict";
        var r = Array.prototype.slice, o = n(9), i = Object.keys, a = i ? function (e) {
            return i(e)
        } : n(37), s = Object.keys;
        a.shim = function () {
            if (Object.keys) {
 ...
 */
        ...
        "use strict";
        var r = n(11), o = n(8), i = n(10), a = n(12), s = n(47), l = r(a());
        ...
        "use strict";
        var r = n(0), o = n(11), i = o(r("String.prototype.indexOf"));
        e.exports = function (e, t) {
            var n = r(e, !!t);
        ...
        var s = n(2).FilterCSS, l = n(14), c = n(15), u = c.parseTag, d = c.parseAttr, p = n(4);
        a.prototype.process = function (e) {
            if (e = e || "", !(e = e.toString())) return "";
            var t = this, n = t.options, i = n.whiteList, a = n.onTag, s = n.onIgnoreTag, c = n.onTagAttr,
                f = n.onIgnoreTagAttr, h = n.safeAttrValue, g = n.escapeHtml, v = t.cssFilter;
