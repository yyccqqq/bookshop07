...
public class BookController {
    ...
    private final static String uploadPath = "http://cn-zz-bgp.sakurafrp.com:10341/group1/upload";

    private final static String deletePath = "http://cn-zz-bgp.sakurafrp.com:10341/group1/delete";
    ...
    public Result upload(MultipartFile file) {
        try {
            ...
            String url = "http://cn-zz-bgp.sakurafrp.com:10341" + Convert.toStr(result.get("path"));
